...
This repository contains custom and curated skills for Gemini CLI and Claude Code, organized for **Obsidian-centric** and **Visualization** workflows.

## 📂 Skill Categories:

### 🛰️ Obsidian Skills (from [kepano/obsidian-skills](https://github.com/kepano/obsidian-skills))
Managed within the `obsidian-skills/` directory:
- **[my-defuddle](./obsidian-skills/my-defuddle)**: (Modified) Enhanced YouTube extraction with exhaustive analysis and Obsidian callouts.
